            ...
            <table class="table text-nowrap" id="dataTable" name='dataTable'>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  {{-- <td class="align-middle">{{$item->generatedBy->fname ?
                    '(Acc)-'.Str::limit($item->generatedBy->fname, 7,'...' ) :
                    '(Adm)-'.Str::limit($item->generatedBy->name, 7,'...' )}}</td> --}}
                  ...
                  <td class="align-middle" style="color: {{!$item->paymentEvidence ? 'red' : 
                    ...
                    <strong>
                      ...
                      'UNPAID' :
                      ($item->isPayEvidenceApproved && $item->paymentEvidence ? 'Paid & Confirmed' : 'Awaiting
                      Confirmation')
                      }}
                    </strong>
                  </td>
