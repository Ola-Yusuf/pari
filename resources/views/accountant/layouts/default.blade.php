...
<body>
  <div id="db-wrapper">
    <!-- navbar vertical -->
    <!-- Sidebar -->
    @include('accountant.layouts.side_nav')

    <!-- Page content -->
    <div id="page-content">
      <div class="header @@classList">
        <!-- navbar -->
        @include('accountant.layouts.search_and _user')
      </div>
      <!-- Container fluid -->
      @yield('content')
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="{{route('accountant.reset.password')}}">
            @csrf
            ...
            <br>
            <div class="form-group row">
              <label for="password_confirmation" class="col-md-4 col-form-label text-md-right">{{ __('Confirm New
                Password') }}</label>
