      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-12">
        <div class="card h-100">
          ...
          <div class="card-header bg-white border-bottom-0 py-4">
            <h4 class="mb-0"> All Products/Service </h4>
          </div>
          <!-- table  -->
          <div class="table-responsive" style="padding: 10px;">
                ...
                <tr>
                  ...
                  <td class="align-middle">
                    <div class="d-flex align-items-center">
                      <div class="ms-3 lh-1">
                        <h5 class="fw-bold mb-1">{{$item->serial}}</h5>
                  ...
                  <td class="align-middle" style="color: {{$item->isDelivered ? 'green' : 'black' }}">
                    {{$item->isDelivered ? 'Delivered' : 'No' }}</td>
            ...
            @else
            <p>Products/Service Not Avalable At The Moment</p>
            @endif
