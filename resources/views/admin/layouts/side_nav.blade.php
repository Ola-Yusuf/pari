...
<nav class="navbar-vertical navbar">
    <div class="nav-scroller">
        ...
        <a class="navbar-brand" href="{{route('admin.home')}}">
            <img src="{{asset('parigyan.png')}}" width="200" height="70" alt="" />
        </a>
        <!-- Navbar nav -->
        <ul class="navbar-nav flex-column" id="sideNavbar">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link has-arrow  collapsed " href="#!" data-bs-toggle="collapse"
                    data-bs-target="#navAccountant" aria-expanded="false" aria-controls="navAuthentication">
            ...
            <!-- Nav item -->
            <li class="nav-item">
                <a class="nav-link has-arrow  collapsed " href="#!" data-bs-toggle="collapse" data-bs-target="#sales"
